...
type Movie struct {
	...
	// Version will be incremented each time the movie information changes.
...
func ValidateMovie(v *validator.Validator, movie *Movie) {
	...
	v.Check(movie.Year >= 1888, "year", "must be equal or greater than 1888")
...
// Delete deletes a specific record of the movie table.
