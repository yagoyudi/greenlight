...
import (
	...
	"github.com/yagoyudi/greenlight/internal/jsonlog"
	"github.com/yagoyudi/greenlight/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "616683ea75bce6", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "a5a479e308737f", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.yagoyudi>", "SMTP sender")
